        ...
        <Stack direction={['column', 'row']} h={'100vh'}>
            <VStack w={'full'}>
                ...
                <VStack alignItems={'flex-start'} w={'full'} p={'4'} overflowY={'auto'}>
                    ...
                    <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod ut, rem quibusdam libero dolor tempora possimus? Natus ea commodi dolorum voluptates cupiditate qui, porro fugiat quos sed, laudantium sit. Nisi.Lorem ipsum dolor sit amet consectetur adipisicing elit.</Text>
                </VStack>
            </VStack>
            <VStack w={['full', 'xl']} alignItems={'stretch'} p={'4'} overflowY={'auto'}>
                {
                    videosArr.map((item, index) => {
                        return <Button variant={'ghost'} colorScheme={'purple'} onClick={()=>setVideoSrc(item)}>Lecture {index + 1}</Button>
                    })
                }
            </VStack>
        </Stack>
